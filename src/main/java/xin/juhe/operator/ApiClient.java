...
import xin.juhe.operator.auth.Authentication;
import xin.juhe.operator.auth.HttpBasicAuth;
import xin.juhe.operator.auth.HttpBearerAuth;
import xin.juhe.operator.auth.ApiKeyAuth;
...
public class ApiClient {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.juhe.xin
